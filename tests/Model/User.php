...
namespace Atlance\HttpDbalFilter\Test\Model;
 ...
 * @ORM\Entity(repositoryClass="Atlance\HttpDbalFilter\Test\Repository\UserRepository")
 */
class User
{
    /**
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="Atlance\HttpDbalFilter\Test\Model\BankingCard", fetch="EAGER", cascade={"persist"})
     *
     * @ORM\JoinTable(
     *     name="users_cards",
     ...
     * @var Passport
     *
     * @ORM\OneToOne(targetEntity="Atlance\HttpDbalFilter\Test\Model\Passport", fetch="EAGER", mappedBy="user", cascade={"persist"})
     */
    private $passport;
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="Atlance\HttpDbalFilter\Test\Model\Phone", mappedBy="user", fetch="EAGER", cascade={"persist"})
     */
    private $phones;
